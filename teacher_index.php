...
<header id="hd">
    ...
    <div id="hd_wr">
        ...
        <div id="logo"><a href="/voiceyoutest/teacher_index.php"><img src="/voiceyoutest/img/logo (2).png" alt=""></a></div>    
        ...
        <!--  <span id="button"><button id="btn" type="submit" onclick="location.href = '../m/login.html';"><img src="../img/login.png"></button>
          ...
          <div id="gnb" class="hd_div">
            ...
            <li class="gnb_1dli">
                ...
                <li class="gnb_1dli">
                    <a href="/voiceyoutest/teacher_index.php" class="gnb_1da">Home</a>
                </li>
                <li class="gnb_1dli">
                    <a href="javascript:script();" class="gnb_1da">Lecture</a>

                </li>
                <li class="gnb_1dli">
                    <a href="/voiceyoutest/mobile/teacher_chart.php" class="gnb_1da">Chart</a>
                </li>
            <!--    <li class="gnb_1dli">
          ...
          <!--  </span>
            ...
            <li class="gnb_1dli">
                ...
                <li class="gnb_1dli">
                    ...
                    <ul class="gnb_2dul">
                        <li class="gnb_2dli"><a href="/voiceyoutest/mobile/te_feedback_chart.php" class="gnb_2da"><span></span>Feedback</a></li>
                         
                        <li class="gnb_2dli"><a href="/voiceyoutest/mobile/script_new.php" class="gnb_2da"><span></span>Lecture upload</a></li>
...
<!--
    ...
    <!-- 상단 메뉴 시작 -->
    <ul id="hd_mb">
        <li><a href="/voiceyoutest/teacher_index.php" class="on">Home</a></li>
        <li><a href="/voiceyoutest/mobile/script.php">Lecture</a></li>
        <li><a href="/voiceyoutest/mobile/teacher_chart.php">Chart</a></li>
...
<div id="wrapper">
    ...
    <!--// 메인 비쥬얼 -->
    <div class="banner3">
        <p><strong><?php echo $_SESSION["id"];?>님&nbsp;콘텐츠에 대한 평가를 남기고 수익을 창출해 보세요<i>!</i></strong></p>
        <a href="/voiceyoutest/mobile/teacher_chart.php">바로가기</a>
    </div>
    <!--<?php if(isset($_SESSION["id"])) { ?>
    <div class="banner2">
