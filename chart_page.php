...
<div class="fixed_menu">
	...
	<div class="fixed_menu">
      <ul>
        <li class="topMenuLi"><a class="menuLink" href="chart_page.php"><font style="color: rgb(176,176,176)">연설</font></a></li>
...
<?php
 include 'db.php';
  ...
  mysqli_set_charset($link, "utf8"); //한국어 인코딩 코드
   $select_query = "SELECT title, script, index_id, Chart_category FROM Chart_script WHERE Chart_category='speech'";
